...
function getStepSummary(step: CustomBuilderStep, selections: CustomBuildSelections, switchCount: number): string | null {
  switch (step) {
    ...
    case "keycaps":
      if (selections.keycaps.keycapSetId && selections.keycaps.setName) return selections.keycaps.setName;
...
export function getSwitchCount(size: string): number {
  const sizeMap: Record<string, number> = {
    "40%": 47, "60%": 61, "65%": 68, "75%": 84, "TKL": 87, "80%": 87,
    "96%": 99, "1800": 99, "100%": 104, "Full-size": 104, "full size": 104, "full-size": 104,
  };
