        ...
        {sponsorships.map((s: any) => (
          <a
            ...
            className={cn(
              ...
              "rounded-xl border border-border-subtle bg-bg-surface pl-2 pr-5 py-2",
          ...
          >
            {/* Square thumbnail */}
            <div className="w-20 h-20 rounded-lg overflow-hidden bg-bg-elevated shrink-0 relative">
              <img
                src={s.imageUrl}
                alt={s.productName}
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-semibold text-text-primary truncate max-w-[180px] font-[family-name:var(--font-outfit)] group-hover:text-accent transition-colors duration-150">
                {s.productName}
              </p>
              {s.priceUsd != null && (
            ...
            {/* Arrow */}
            <svg className="w-4 h-4 text-text-muted group-hover:text-accent shrink-0 transition-colors duration-150 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
